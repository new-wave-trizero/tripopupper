...
},{"select":10}],2:[function(require,module,exports){
(function (global, factory) {
    if (typeof define === "function" && define.amd) {
...
var laravel = JSON.parse(atob(window.laravel));
...
var _laravelConfig = require('./laravel-config');

var _laravelConfig2 = _interopRequireDefault(_laravelConfig);
...
var defaultizeJson = function defaultizeJson(emptyEditorValue, json) {
  return (0, _lodash.merge)(emptyEditorValue, json);
...
function popupEditPage(element) {
  ...
  var popup = $(editorContainer).data('popup');
  ...
  JSONEditor.defaults.options.upload = function (type, file, cbs) {
    ...
    $.ajax({
      type: 'POST',
      url: _laravelConfig2.default.app_url + '/popup/' + popup.name + '/upload-image',
      ...
      return cbs.failure('Errore nell\'upload del file');
    });
  ...
  var fillInputWithJson = function fillInputWithJson() {
    return $input.val(JSON.stringify(editor.getValue()));
  };
  ...
  $('#popup-snippet-debug-mode-toggle').on('change', function () {
    var isInDebugMode = $(this).is(':checked');
...
},{"./laravel-config":12,"json-editor":7,"lodash":8}],14:[function(require,module,exports){
'use strict';
...
$.ajaxSetup({
  headers: {
    'X-CSRF-TOKEN': _laravelConfig2.default.csrf_token
  }
});
...
},{"./laravel-config":12,"./popup-edit-page":13,"clipboard":2}]},{},[14]);
